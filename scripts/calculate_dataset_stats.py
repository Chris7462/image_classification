...
Usage:
    python utils/calculate_dataset_stats.py \
...
from utils import Config    # pylint: disable=import-error


def calculate_mean_std(data_root, resize_size, crop_size, batch_size=64,
                       num_workers=4):
    """
...
def main():
    ...
    try:
        mean, std = calculate_mean_std(data_root, resize_size, crop_size,
